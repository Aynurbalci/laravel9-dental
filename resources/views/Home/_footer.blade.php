<footer id="footer">
    ...
    <a href="#">
    <img src="{{ asset('assests') }}/dent/assets/image/Logolight.webp" alt="image">
    </a>
    </div>
    <h3 class="copyright">
...
<script data-cfasync="false" src="{{ asset('assests') }}/dent/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/jquery.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/bootstrap.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/jquery.easing.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/jquery-countTo.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/jquery-validate.js"></script>

<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/rev-slider.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/revolution/js/extensions/revolution.extension.video.min.js"></script>

<script src="{{ asset('assests') }}/dent/assets/animation/wow.min.js"></script>
<script src="{{ asset('assests') }}/dent/javascript/animation.js"></script>

<script src="{{ asset('assests') }}/dent/owlcarousel/owl.carousel.min.js"></script>
<script src="{{ asset('assests') }}/dent/owlcarousel/carousel.js"></script>
<script type="text/javascript" src="{{ asset('assests') }}/dent/javascript/main.js"></script>
