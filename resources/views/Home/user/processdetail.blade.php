...
@section('title', 'User Process Detail')
                    ...
                    <div class="cart-page-inner">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($processtreatment as $rs)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($rs->status=="New")
                                            <a
                                                class="icons8-delete" href="{{ route('userpanel.canceltreatment', ['id' => $rs->id]) }}"
                            ...
                            <div class="col-md-12">
                                <div class="cart-summary">
                                    <div class="cart-content">
                                        ...
                                        <p>Total :<span>${{$process->total}}</span></p>
