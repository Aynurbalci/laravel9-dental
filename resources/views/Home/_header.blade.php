            ...
            <div class="nav-wrap">
                <nav id="mainnav" class="mainnav">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="blog-details.html" title="">     @auth
                                            ...
                                            <a href="{{route('userpanel.index')}}"><i class="bi bi-chat-left-quote"></i>My Profile</a>
                                            <a href="{{route('userpanel.processes')}}">My Process</a>
                        ...
                        <li>
                            <a href="{{ route('randevu.index') }}"  class="notification"><i class="bi bi-bag-plus-fill">
                                    ...
                                    <span class="badge">{{\App\Http\Controllers\RandevuController::countRandevu()}}</span>
