...
<body>
    ...
    <script src="{{asset('assests')}}/admin/asset/assets/vendor/jquery/jquery-3.3.1.min.js"></script>
    <script src="{{asset('assests')}}/admin/asset/assets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
    <script src="{{asset('assests')}}/admin/asset/assets/vendor/slimscroll/jquery.slimscroll.js"></script>
    <script src="{{asset('assests')}}/admin/asset/assets/libs/js/main-js.js"></script>
</body>
