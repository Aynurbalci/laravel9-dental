...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item ">
            <a class="nav-link {{request()->routeIs('/admin/treatment/') ? 'active' : ''}}" href="/admin/treatment">
        ...
        <li class="nav-item ">
            <a class="nav-link" href="{{@route('admin.process.index',['slug'=>'New'])}}">
                <i class="menu-icon mdi mdi-pencil-box-outline"></i>
                <span class="menu-title">New Process</span>
            </a>
        </li>
        <li class="nav-item ">
            <a class="nav-link" href="{{@route('admin.process.index',['slug'=>'Accepted'])}}">
                <i class="menu-icon mdi mdi-pencil-box-outline"></i>
                <span class="menu-title">Accepted Process</span>
            </a>
        </li>
        <li class="nav-item ">
            <a class="nav-link" href="{{@route('admin.process.index',['slug'=>'Shipped'])}}">
                <i class="menu-icon mdi mdi-pencil-box-outline"></i>
                <span class="menu-title">Shipped Process</span>
            </a>
        </li>
        <li class="nav-item ">
            <a class="nav-link" href="{{@route('admin.process.index',['slug'=>'Canceled'])}}">
                <i class="menu-icon mdi mdi-pencil-box-outline"></i>
                <span class="menu-title">Canceled Process</span>
            </a>
        </li>
        <li class="nav-item ">
            <a class="nav-link" href="{{@route('admin.process.index',['slug'=>'Completed'])}}">
                <i class="menu-icon mdi mdi-pencil-box-outline"></i>
