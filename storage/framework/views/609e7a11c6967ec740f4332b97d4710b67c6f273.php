...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item <?php echo e(request()->routeIs('admin.category.index') ? 'active' : ''); ?>">
        ...
        <li class="nav-item ">
            <a class="nav-link <?php echo e(request()->routeIs('/admin/treatment/') ? 'active' : ''); ?>" href="/admin/treatment">
