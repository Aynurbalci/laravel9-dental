<?php $__env->startSection('title', 'Dental Appointment System'); ?>
                    ...
                    <div class="box-intro-top">
                        <div class="box-features-intro">
                            ...
                            <div class="features-intro-top wow fadeInDown">
                                ...
                                <div class="features-inner">
                                    <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/pattern/Path18193.webp"
                                         alt="image">
                                </div>
                            </div>
                        ...
                        <div class="box-content-intro">
                            ...
                            <div class="box-button">
                                <a href="<?php echo e(route('randevu.index')); ?>"
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="box-features-bot">
                        ...
                        <img class="flat-img-intro"
                             src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/MaskGroup10.webp" alt="image">
                        ...
                        <div class="item box-item-carousel wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <div class="info">
                                <h2 class="name text-color-title-sidebar"><a
                                        href="<?php echo e(route('treatment',['id' =>$rs->id])); ?>"><?php echo e($rs->title); ?></a></h2>
                                ...
                                <div class="ratting">
                                    ...
                                    (<?php echo e($rs->comment->count('id')); ?>)
                                </div>
                                <a class="btn" href="<?php echo e(route('treatment',['id' =>$rs->id])); ?>"><i
                            ...
                            <div class="box-process wow fadeInUp">
                                ...
                                <div class="box-wrap pdt-30">
                                    ...
                                    <div class="flat-read-more">
                                        <a href="<?php echo e(route('treatment',['id' =>$rs->id])); ?>"
                ...
                <div class="owl-carousel owl-theme none latest-box cursor-resize" data-margin="30" data-desktop="3"
                    ...
                    <div class="box-article">
                        <div class="item wow fadeInUp">
                            <div class="feature-post">
                                <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/doctor02.webp" alt="image">
                    ...
                    <div class="box-article">
                        <div class="item wow fadeInUp" data-wow-duration="1s" data-wow-delay="100ms">
                            <div class="feature-post">
                                <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/doctor03.webp" alt="image">
                                <div class="overlay-post"></div>
                            </div>
                            <div class="content-post  art">
                                <ul class="meta">
                    ...
                    <div class="box-article">
                        <div class="item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="200ms">
                            <div class="feature-post">
                                <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/doctor01.webp" alt="image">
                                <div class="overlay-post"></div>
                            </div>
                            <div class="content-post art">
                                <ul class="meta">
