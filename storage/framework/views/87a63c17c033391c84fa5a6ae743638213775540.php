        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".2s">
                ...
                <div class="t-box">
                    ...
                    <ul class="social-links">
                        <li><a class="wow fadeInUp animated" href="<?php echo e(asset('assests')); ?>/index.html#"><i class="fa fa-facebook"></i></a></li>
                        <li><a data-wow-delay=".1s" class="wow fadeInUp animated" href="index.html#"><i class="fa fa-twitter"></i></a></li>
                        <li><a data-wow-delay=".2s" class="wow fadeInUp animated" href="<?php echo e(asset('assests')); ?>/index.html#"><i class="fa fa-google-plus"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".3s">
                ...
                <div class="t-box">
                    ...
                    <ul class="social-links">
                        <li><a class="wow fadeInUp animated" href="<?php echo e(asset('assests')); ?>/index.html#"><i class="fa fa-facebook"></i></a></li>
                        <li><a data-wow-delay=".1s" class="wow fadeInUp animated" href="<?php echo e(asset('assests')); ?>/index.html#"><i class="fa fa-twitter"></i></a></li>
                        <li><a data-wow-delay=".2s" class="wow fadeInUp animated" href="<?php echo e(asset('assests')); ?>/index.html#"><i class="fa fa-google-plus"></i></a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="big-demo go-wide" data-js-module="filtering-demo">
        ...
        <div class="grid baguetteBoxThree gallery">
            <div class="element-item transition webdesign " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-1.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-1.jpg" />
                    <div class="hover-img">
            ...
            <div class="element-item post-transition ecommerce " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-2.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-2.jpg" />
                    <div class="hover-img">
                        <h2>E-commerce</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition webdesign " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-3.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-3.jpg" />
                    <div class="hover-img">
                        <h2>Website Design</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item transition ecommerce " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-4.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-4.jpg" />
                    <div class="hover-img">
                        <h2>E-commerce</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition logo " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-5.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-5.jpg" />
                    <div class="hover-img">
                        <h2>Logo</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition cms " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-6.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-6.jpg" />
                    <div class="hover-img">
                        <h2>CMS</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition logo " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-7.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-7.jpg" />
                    <div class="hover-img">
                        <h2>Logo</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item transition cms " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-8.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-8.jpg" />
                    <div class="hover-img">
                        <h2>CMS</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition ecommerce " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-9.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-9.jpg" />
                    <div class="hover-img">
                        <h2>E-commerce</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition webdesign " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-10.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-10.jpg" />
                    <div class="hover-img">
                        <h2>Web Design</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item post-transition logo " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-11.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-11.jpg" />
                    <div class="hover-img">
                        <h2>Logo</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
            ...
            <div class="element-item transition cms " data-category="post-transition">
                <a href="<?php echo e(asset('assests')); ?>/img/gallery/emp-12.jpg">
                    <img src="<?php echo e(asset('assests')); ?>/img/gallery/emp-12.jpg" />
                    <div class="hover-img">
                        <h2>CMS</h2>
                        <i class="fa fa-camera camera"></i>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp animated" data-wow-delay=".1s">
                <div class="blog-img">
                    <img src="<?php echo e(asset('assests')); ?>/img/blog1.JPG" />
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo e(asset('assests')); ?>/blog-single.html">MORE</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".4s">
                <div class="blog-img">
                    <img src="<?php echo e(asset('assests')); ?>/img/blog2.JPG" />
                </div>
                <div class="row">
                    <div class="data">30</div>
                    <div class="month">March</div>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInDown animated" data-wow-delay=".3s">
                <div class="blog-img">
                    <img src="<?php echo e(asset('assests')); ?>/img/blog3.JPG" />
                </div>
                <div class="row">
                    <div class="data">30</div>
                    <div class="month">March</div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel9-dental/resources/views/home/index.blade.php ENDPATH**/ ?>