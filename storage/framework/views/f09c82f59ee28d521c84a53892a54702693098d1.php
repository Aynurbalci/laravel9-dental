<section class="fl-row intro-top">
    ...
    <div class="themesflat-spacer clearfix" data-desktop="40" data-mobile="40" data-smobile="40"></div>
    <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/process01.webp" alt="image">
    </div>
    ...
    <div class="box-process wow fadeInUp" data-wow-delay="100ms">
     <div class="feature-process">
    <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/process02.webp" alt="image">
    </div>
    <div class="box-wrap pdt-30">
    <h2>
    Pediatric Dentistry
    ...
    <img src="<?php echo e(asset('assests')); ?>/dent/assets/image/common/process03.webp" alt="image">
    </div>
    <div class="box-wrap pdt-30">
    <h2>
    Dental Implants
...
<?php /**PATH /Applications/MAMP/htdocs/laravel9-dental/resources/views/home/_content.blade.php ENDPATH**/ ?>