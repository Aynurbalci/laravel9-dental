<footer id="footer">
    ...
    <span><a href="https://themesflat.com/cdn-cgi/l/email-protection#d4adbba1a6b9b5bdb8fa94b3b9b5bdb8fab7bbb9"><span class="__cf_email__" data-cfemail="b6cfd9c3c4dbd7dfda98f6d1dbd7dfda98d5d9db">[email&#160;protected]</span></a></span>
    </li>
    </ul>
    </div>
...
<script data-cfasync="false" src="<?php echo e(asset('assests')); ?>/dent/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
...
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assests')); ?>/dent/revolution/js/extensions/revolution.extension.video.min.js"></script>
