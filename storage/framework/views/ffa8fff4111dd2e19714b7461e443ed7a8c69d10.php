                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="<?php echo e(route('admin.treatment.update', ['id' => $data->id])); ?>" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputText3" value="<?php echo e($data->price); ?>" type="number" class="form-control" name="price">
                                        </div>
                                        <div class="form-group">
