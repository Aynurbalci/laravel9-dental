                            ...
                            <table class="table table-bordered">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($rs->treatment->price); ?></td>
                                        <form action="<?php echo e(route('randevu.update',['id'=>$rs->id])); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                        <td>

                                                <input type="date" name="date" value="<?php echo e($rs->date); ?>" min="<?php echo e($rs->date); ?>"
                                        ...
                                        <td>
                                                ...
                                                <input type="time" name="time" value="<?php echo e($rs->time); ?>" min="<?php echo e($rs->time); ?>"
                                                       onchange="this.form.submit()">
                                                    ...
                                                    <?php $__currentLoopData = $us->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($role->name=='doctor'): ?>
                                                            <option class="nav-link dropdown-toggle"
                                                                    ...
                                                                    aria-expanded="false"
                                                                    value="<?php echo e($us->id); ?>" onchange="this.form.submit()"><?php echo e($us->name); ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        ...
                                        <td>
                                            <a
                                                class="icons8-delete" href="<?php echo e(route('randevu.destroy',[$rs->id])); ?>"
                            ...
                            <div class="col-md-12">
                                <div class="cart-summary">
                                    <div class="cart-content">
                                        ...
                                        <form action="<?php echo e(route('randevu.process')); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                            <input name="total" value="<?php echo e($total); ?>" type="hidden">
